...
To make python project easily. Just practice these exercises and master your knowledge of Python. Easy python projects with basic exercises in python IDE. _[here](https://pythonid.com/user/doan/projects/5-exercises-to-help-make-python-projects-easy)_
...
1. Python Tutorial
   ...
   - [Python Lists](https://pythonid.com/tutorials/python-lists)
     ...
     - [List Comprehension](https://pythonid.com/tutorials/list-comprehension)
     - [Loop Lists](https://pythonid.com/tutorials/loop-lists)
     - [Remove List Items](https://pythonid.com/tutorials/remove-list-items)
     - [Add List Items](https://pythonid.com/tutorials/add-list-items)
     - [Change List Items](https://pythonid.com/tutorials/change-list-items)
     - [List Methods](https://pythonid.com/tutorials/list-methods)
   - [Python Tuples](https://pythonid.com/tutorials/python-tuples)
     - [Update Tuples](https://pythonid.com/tutorials/update-tuples)
     - [Access Tuple Items](https://pythonid.com/tutorials/access-tuple-items)
     - [Unpacking Tuples](https://pythonid.com/tutorials/unpacking-tuples)
